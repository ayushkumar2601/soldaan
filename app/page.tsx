...
//         <Navbar />
//         <main className="relative flex min-h-screen flex-col items-center justify-center px-4 pb-34">
//           <Hero />
//           <FaucetForm />
//         </main>
//         <div className="">
...
export default function Page() {
  return (
    <SolanaWalletProvider>
      <div className="relative flex h-screen flex-col overflow-hidden bg-gradient-to-br from-[#0a1e1e] via-[#0d2626] to-[#1a1420]">
        {/* Vignette effect */}
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_0%,rgba(0,0,0,0.6)_100%)]" />
        {/* Center glow */}
        <div className="pointer-events-none absolute left-1/2 top-1/2 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-teal-500/10 blur-[120px]" />
        ...
        <div className="relative flex h-full flex-col">
          ...
          <main className="flex flex-1 flex-col items-center justify-center px-3 mt-[-40]">
            <Hero />
            <FaucetForm />
          </main>
